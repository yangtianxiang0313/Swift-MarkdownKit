...
public final class TextFragment: LeafFragment, ProgressivelyRevealable, TransitionPreferring, AttributedStringProviding, MergeableFragment {
    ...
    public init(
        ...
        reuseIdentifier: ReuseIdentifier = .textView,
    ...
    public func canMerge(with other: RenderFragment) -> Bool {
        guard let rhs = other as? TextFragment else { return false }
        guard reuseIdentifier == .textView, rhs.reuseIdentifier == .textView else { return false }
        guard let lhs = attributedString, let rhsAttr = rhs.attributedString else { return false }

        // Keep layout-compatible text fragments mergeable.
    ...
    public func merged(with other: RenderFragment, interFragmentSpacing: CGFloat) -> RenderFragment {
        guard let rhs = other as? TextFragment,
