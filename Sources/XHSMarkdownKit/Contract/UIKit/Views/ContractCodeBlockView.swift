...
public final class ContractCodeBlockView: UIView, HeightEstimatable, StreamableContent {
    ...
    public func estimatedHeight(atDisplayedLength: Int, maxWidth: CGFloat) -> CGFloat {
        ...
        if atDisplayedLength >= fullCode.count {
            ...
            let index = fullCode.index(
                fullCode.startIndex,
                offsetBy: max(0, min(atDisplayedLength, fullCode.count))
            )
